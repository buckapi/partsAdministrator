...
import { HttpClient } from '@angular/common/http';import PocketBase from 'pocketbase';
...
newCategory:string;
  ...
  assetments: any[] = [];
  info: { id:string,name: string, colors: { name: string, hex: string }[], orderStatus:{name:string,id:string}[] } = {
    name: "none",
    id:'',
    orderStatus:[],
    colors: [
